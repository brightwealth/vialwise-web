    ...
    <section id="features" className="mx-auto max-w-6xl px-6 py-24 md:px-10 md:py-32">
      ...
      <div className="mt-16 grid grid-cols-1 gap-5 md:grid-cols-3 md:gap-6">
        ...
        <FeatureCard
          ...
          body="64 peptide entries with primary-source citations — PubMed DOIs, ClinicalTrials.gov NCTs, FDA labels. Reconstitution tables are calculator-rendered, never hand-typed. Tap &ldquo;Use in calculator&rdquo; on any entry to jump straight into the math with that peptide pre-picked."
          icon={<LibraryIcon />}
          accent="forest"
        />
        <FeatureCard
